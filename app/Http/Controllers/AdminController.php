...
class AdminController extends Controller
{
    ...
    public function profileUpdate(Request $request)
    {
        ...
        $user->save();
        return redirect()->route('admin.profile')->with(['class'=>'success','message'=>'Profile Updated Successfully.']);
    }
    ...
    public function passwordUpdate(Request $request)
    {
        ...
        return redirect()->route('admin.profile')->with(['class'=>'success','message'=>'Password Changed Successfully.']);;
    }
